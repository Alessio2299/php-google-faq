<?php
  $faq = [
    'question1' => [
      'question' => "How are you implementing the recent Court of Justice of the European Union (CJEU) decision on the right to be forgotten?</p>",
      'answer' => 
      ...
      <p>If you have a removal request, please fill out this <a href='#'>webform</a>. You'll receive an automatic reply confirming that we have received your request. We will then assess your case—please note this may take some time because we have already received many such requests. In evaluating your request, we will look at whether the results include outdated information about your private life. We'll also 
      look at whether there's a public interest in the information remaining in our search results—for example, if it relates to financial scams, professional malpractice, criminal convictions or your public conduct as a government official (elected or unelected). These are difficult judgements and as a private organization, we may not be in a good position to decide on your case. If you disagree with our decision you can contact your local DPA.</p>
    ...
    'question2' => [
      'question' => "How does Google protect my privacy and keep my information secure?<br><br>",
      'answer' => 
    ...
    'question3' => [
      'question' => "Why is my account associated with a country?</p>",
      'answer' => 
    ...
    'question4' => [
      'question' => "Determining the country associated with your account</p>",
      'answer' => 
  ...
  <body>
    <header>
      ...
      <div class="bottom-header">
        <ul>
          <li><a href="https://policies.google.com/">Overview</a></li>
          <li><a href="https://policies.google.com/privacy">Privacy Policy</a></li>
          <li><a href="https://policies.google.com/terms">Terms of Service</a></li>
          <li><a href="https://policies.google.com/technologies">Technologies</a></li>
