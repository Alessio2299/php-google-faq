<?php
  $faq = [
    'question1' => [
      ...
      look at whether there's a public interest in the information remaining in our search results—for example, if it relates to financial scams, professional malpractice, criminal convictions or your public conduct as a government official (elected or unelected). These are difficult judgements and as a private organization, we may not be in a good position to decide on your case. If you disagree with our decision you can contact your local DPA.<br><br>
    ...
    'question3' => [
      ...
      Google LLC, based in the United States, for the rest of the world<br><br>
      The version of the terms that govern our relationship, which can vary depending on local laws<br><br>
